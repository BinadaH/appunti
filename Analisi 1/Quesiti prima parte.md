...
# 1.6
#### Illustrare il principio di induzione.
...
#### Sia E ⊆ R. Dare le definizioni di massimo, minimo, maggiorante, minorante di E, sup E, inf E
...
#### Dare la definizione di sottoinsieme di R limitato superiormente o inferiormente illimitato superiormente o inferiormente. Fornirne esempi.
...
# 1.13
#### Enunciare la proprietà di completezza (o di continuità) di R
...
# 1.14
#### Descrivere come in R si definiscono le radici, le potenze ad esponente razionale e reale, i logaritmi. Quale proprietà di R è fondamentale per poterli definire?
...
# 1.15
#### Introdurre le grandezze goniometriche e descriverne le principali proprietà.
...
# 1.16
#### Dare la definizione di valore assoluto di un numero reale e spiegarne le principali
